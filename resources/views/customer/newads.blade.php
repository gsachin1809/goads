...
@section('content')
    <form class="form-horizontal" action="/createads/payment" method="post">
    ...
    <input type="hidden" name="payment_amount" value="500">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="User Id" name="User Id" type="text" placeholder="Contact Person Name" class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="Mail Id " name="Contact number " type="text" placeholder="Contact Person number" class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="Product Name" name="Product Name" type="text" placeholder="Product Name" class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="User Name" name="User Name" type="text" placeholder="Price" class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="Mail Id " name="Mail Id " type="text" placeholder="Discount in percentage  " class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="Mail Id " name="Mail Id " type="text" placeholder="Mail Id " class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <input id="Mail Id " name="Mail Id " type="file" placeholder="Mail Id " class="form-control input-md" >
      ...
      <div class="form-group">
        ...
        <div class="col-md-6">
        <button class="btn btn-success" onclick="addads()" >Add More Ads </button>      
        </div>
      </div>
